 ...
 const createUser= async function (req, res) {
    ...
    // let isFreeAppUser=req.header.isfreeappuser //string
    ...
    if(!name || !address || !balance || !gender || !age){
       return res.send({message:"all field is mandotory"})
    }
    let userDetails=await userModel.create({name ,address,balance,gender,age,isFreeAppUser} )
